              ...
              <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                  ...
                  <div className="space-y-4 md:space-y-6">
                      ...
                      <div>
                          ...
                          <input value={formData.password} onChange={changeHandler} type="password" name="password" placeholder="Enter your password" className={`bg-gray-50 border ${errors.password ? 'input-error' : 'border-gray-300'} text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500`}/>
                          {/* Validate Password */}
