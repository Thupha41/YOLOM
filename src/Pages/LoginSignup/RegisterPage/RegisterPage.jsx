...
const RegisterPage = () => {
    ...
    const inputs = [
    ...
    
        {
            ...
            errorMessage: "Phone number must be 10 digits long and start with '0' followed by 3, 5, 7, 8, or 9",
            required: true
        },
  ...
  const onChange = (e) => {
    ...
    // setFormData({ ...formData, [name]: value });
    // if (errors[name]) {
    //   // Only update errors if there is an existing error for this field
    ...
    //   if (isValid) {
    //       signup(); // If no errors, proceed to signup
    //   } else {
    //       console.log("Errors in form", newErrors);
    ...
    const signup = async () => {
      ...
      try {
          const response = await axios.post('https://api.yourrlove.com/v1/signup', formData, {
              headers: {
    ...
    <section className='register'>
      <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0 w-full">
          <a href="/" className="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
            <span style={{ fontFamily: 'Suranna', fontSize: '28px', fontWeight: 'bold' }}>YOLOM  </span>  
          </a>
          ...
          <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              {Object.values(errors).some(error => error) && <p style={{ color: 'red' }}>Please correct the errors below.</p>}
              <div className="space-y-4 md:space-y-6">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="flex items-start">
                        ...
                        <div className="ml-3 text-sm">
                            <label htmlFor="remember" className="text-gray-500 dark:text-gray-300">
                              I accept the  
                              <Link className="font-medium text-primary-600 hover:underline dark:text-primary-500" to="/customer-support#terms" onClick={() => window.scrollTo(0,150)}> Terms and Conditions</Link>
                            </label>
                        </div>
                    </div>
                  </div>
                  ...
                  <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                    ...
                    <a href="/login" className="font-medium text-primary-600 hover:underline dark:text-primary-500"> Sign in here</a>
                  </p>
                </form>
                {/* ------------------ */}
