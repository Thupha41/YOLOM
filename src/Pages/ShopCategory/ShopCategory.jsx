...
const ShopCategory = (props) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.post('https://api.yourrlove.com/v1/web/products/filter', {
                    filters: filters,
        ...
        setFilters((prevFilters) => {
            ...
            if (name === 'price') {
                ...
                if (checked) {
                    ...
                    newFilters[name] = newFilters[name] ? newFilters[name].filter((item) => item !== value) : null;
    ...
    const removeFilter = (filterType, value) => {
        ...
        setCheckedState((prevCheckedState) => {
            ...
            if (filterType === 'price') {
                ...
                newCheckedState[filterType] = { ...newCheckedState[filterType], [value]: false };
            }
    ...
    return (
        <div className="mx-auto p-2 mb-20">
            ...
            {/* Title */}
            <h1 className="text-4xl font-regular font-spartan mb-10 mt-10 ml-10">{title}</h1>
                    ...
                    <div className="w-full flex flex-col md:flex-row md:items-center justify-between mb-4">
                        ...
                        <div className="flex items-center gap-2 md:gap-6 mt-4 md:mt-0">
                            <div className="flex items-center gap-2 text-base text-[#767676] relative">
                                ...
                                <select className="w-32 md:w-48 border-[1px] border-gray-200 py-1 px-4 cursor-pointer text-black text-base block dark:placeholder-gray-400 appearance-none focus-within:outline-none focus-visible:border-black" onChange={handleSortChange}>
                            ...
                            <div className="flex items-center gap-2 text-[#767676] relative">
                                ...
                                <select name="limit" className="w-16 md:w-20 border-[1px] border-gray-200 py-1 px-4 cursor-pointer text-black text-base block dark:placeholder-gray-400 appearance-none focus-within:outline-none focus-visible:border-black">
...
ShopCategory.propTypes = {
    ...
    Brand: PropTypes.oneOf(['BANANA_REPUBLIC', 'MANGO', 'COTTON ON', 'OLD NAVY', "LEVI'S", 'O21_CTTT', 'GAP']),
};
