...
const RecentlyViewedProducts = () => {
    ...
    useEffect(() => {
        ...
        const detailedProducts = viewedProducts.map(viewedProduct => 
    ...
    return (
        <div className='product-slider mt-40 mb-20'>
            <h3 data-aos="fade-up" className='text-3xl font-semibold text-center max-w-[600px] mx-auto tracking-wide font-spartan'>
                Recently Viewed Products
            </h3>
            <div data-aos="fade-up" className="max-w-screen-2xl mx-auto container xl:px-28 px-4 mt-16">
                <Slider {...settings}>
