...
const CartItems = () => {
  const { removeFromCart, totalCartAmount, cartItems, getTotalCartItems } =
      ...
      {!isCartEmpty ? (
          ...
          <div className="max-w-screen-2x1 mx-auto container xl:px-28 px-4 mb-20">
            ...
            <div className="flex items-center flex-col sm:flex-row justify-center gap-20 mt-8">
              <Link
                to="/"
                onClick={() => window.scrollTo(0, 0)}
                className="rounded-full py-4 w-full max-w-[280px] border border-gray-300 flex items-center bg-indigo-50 justify-center transition-all duration-500 hover:bg-indigo-100"
              >
                <button>
              ...
              <Link
                to="/checkout"
                onClick={() => window.scrollTo(0, 0)}
                className="rounded-full w-full max-w-[280px] py-4 text-center justify-center items-center bg-black font-semibold text-lg text-white flex transition-all duration-500 hover:bg-indigo-700"
              >
        ...
        >
          ...
          <div className="max-w-[500px] p-4 py-8 bg-white flex gap-4 flex-col items-center rounded-md shadow-lg">
            ...
            <button
              className="bg-primeColor rounded-md cursor-pointer hover:bg-black active:bg-gray-900 px-8 py-2 font-titleFont font-semibold text-lg text-gray-600 hover:text-white duration-300 border"
        ...
        <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex justify-center items-center">
          <div className="bg-white rounded-md p-8 relative">
            ...
            <button
              ...
              className="absolute top-0 right-0 m-4 bg-red-500 h-5 w-5 flex items-center justify-center "
            >
              <IoMdClose className="text-[#ffff]" />
            </button>
          </div>
        </div>
      )}
